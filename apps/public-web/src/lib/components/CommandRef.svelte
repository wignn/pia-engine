<script lang="ts">
	...
	const commands: Command[] = [
		{
			name: '/price',
			description: 'Check current price for a symbol with autocomplete',
			category: 'Market'
		},
		{ name: '/prices', description: 'Show all live market prices', category: 'Market' },
		{
			name: '/market_alert',
			description: 'Set a price alert — get DM when target is hit',
			category: 'Market'
		},
		...
		{
			name: '/forex_news_setup',
			description: 'Setup forex news channel',
			permission: 'Admin',
			category: 'News'
		},
		{
			name: '/forex_news_enable',
			description: 'Enable forex news',
			permission: 'Admin',
			category: 'News'
		},
		{
			name: '/forex_news_disable',
			description: 'Disable forex news',
			permission: 'Admin',
			category: 'News'
		},
		...
		{
			name: '/forex_calendar',
			description: 'View high-impact forex calendar events',
			category: 'News'
		},
		{
			name: '/stocknews subscribe',
			description: 'Subscribe to equity news alerts',
			permission: 'Manage Channels',
			category: 'News'
		},
		{
			name: '/stocknews unsubscribe',
			description: 'Unsubscribe from equity news',
			permission: 'Manage Channels',
			category: 'News'
		},
		...
		{
			name: '/calendar_setup',
			description: 'Setup economic calendar reminders',
			permission: 'Admin',
			category: 'Calendar'
		},
		{
			name: '/calendar_enable',
			description: 'Enable calendar reminders',
			permission: 'Admin',
			category: 'Calendar'
		},
		{
			name: '/calendar_disable',
			description: 'Disable calendar reminders',
			permission: 'Admin',
			category: 'Calendar'
		},
		{ name: '/calendar_status', description: 'Check calendar status', category: 'Calendar' },
		{
			name: '/calendar_mention',
			description: 'Toggle @everyone for events',
			permission: 'Admin',
			category: 'Calendar'
		},
		{
			name: '/twitter_setup',
			description: 'Setup X/Twitter feed channel',
			permission: 'Admin',
			category: 'X Feed'
		},
		{
			name: '/twitter_enable',
			description: 'Enable X feed',
			permission: 'Admin',
			category: 'X Feed'
		},
		{
			name: '/twitter_disable',
			description: 'Disable X feed',
			permission: 'Admin',
			category: 'X Feed'
		},
		{ name: '/twitter_status', description: 'Check X feed status', category: 'X Feed' },
		{
			name: '/volatility_setup',
			description: 'Setup gold volatility alerts',
			permission: 'Admin',
			category: 'Volatility'
		},
		{
			name: '/volatility_disable',
			description: 'Disable volatility alerts',
			permission: 'Admin',
			category: 'Volatility'
		},
		{
			name: '/volatility_status',
			description: 'Check volatility alert status',
			category: 'Volatility'
		},
		{
			name: '/warn',
			...
			<div class="divide-y divide-border-subtle">
				{#each filtered as cmd (cmd.name)}
					...
					>
						...
						{#if cmd.permission}
							<span
								class="hidden shrink-0 rounded border border-border px-2 py-0.5 text-[10px] font-medium text-text-dim sm:inline-block"
							>
								{cmd.permission}
							</span>
						{/if}
