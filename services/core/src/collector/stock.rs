...
static KNOWN_TICKERS: LazyLock<HashSet<&'static str>> = LazyLock::new(|| {
    [
        "BBCA", "BBRI", "BMRI", "BBNI", "TLKM", "ASII", "UNVR", "HMSP", "GGRM", "ICBP", "INDF",
        "KLBF", "PGAS", "PTBA", "ADRO", "ANTM", "INCO", "MDKA", "GOTO", "BUKA", "ARTO", "BRIS",
        "BBTN", "SMGR", "INTP", "EXCL", "ISAT", "TOWR", "TBIG", "MNCN", "SCMA", "AKRA", "UNTR",
        "MEDC", "ESSA", "ACES", "MAPI", "ERAA", "SIDO", "KAEF", "CPIN", "JPFA", "MAIN", "SRIL",
        "TKIM", "INKP", "BRPT", "TPIA", "AMRT", "MIDI", "LPPF", "MYOR", "ROTI", "ULTJ", "MLBI",
        "DLTA", "IHSG", "JKSE",
    ]
    .into_iter()
    .collect()
